                        ...
                        <ul class="nav navbar-nav c-theme-nav">
                            ...
                            <li class="c-menu-type-classic">
                                ...
                                <ul id="children-of-41" class="dropdown-menu c-menu-type-classic c-pull-left ">
                                    ...
                                    <li class="c-menu-type-classic">
                                        <a target='_blank' rel="" href="#"class="">Hướng dẫn nạp
                                            ATM tự động</a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
            <div class="container">
                <div class="c-page-title c-pull-left">
                    <h3 class="c-font-uppercase c-font-sbold"><a href="/blog" title="Blog tin tức">Blog tin tức</a>
                    </h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <input type="text" class="form-control c-square c-theme" name="key"
                                autocomplete="off" autofocus placeholder="Nhập từ khóa..." value=""
                                style="width: 100%">
                        </div>
                        <div class="col-md-4">
                            <input type="submit" class="btn c-theme-btn c-btn-square m-b-10" value="Tìm kiếm">
                            <a class="btn c-btn-square m-b-10 btn-danger" href="https://nick.vn/blog-game">Tất cả</a>
                        </div>
                    </div>
                </form>
                            ...
                            @foreach ($blog as $key => $bl)
                                <div class="a-item">
                                    <div class="thumbnail-image img-thumbnail">
                                        <a href="#">
                                            <img src="{{ asset('uploads/blog/' . $bl->image) }}" height="150px" weight="150px">
                                        </a>
                                    </div>
                                    <div class="info">
                                        ...
                                        <div class="article_cat_date">
                                            <div style="display: inline-block;margin-right: 15px">
                                                <i class="fa fa-calendar" aria-hidden="true"></i> Ngày
                                            </div>
                                        ...
                                        <div class="article_description hidden-xs">
                                            {{ $bl->description }}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="c-content-ver-nav">
                            ...
                            <ul class="c-menu c-arrow-dot1 c-theme">
                                <li><a href="/blog-game">Tất cả</a></li>
                                <li><a href="/blog/uy-tin-cua-nickvn">Uy Tín Của Nick.vn</a></li>
                                <li><a href="/blog/bai-ghim">Bài Ghim</a></li>
                                <li><a href="/blog/tin-game">Tin Game</a></li>
                                <li><a href="/blog/huong-dan">Hướng Dẫn</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="c-container c-first">
                            <p><span style="color:#ffffff"><span
                                    ...
                                    style="color:#16a085"><span
                                        style="font-size:22px"><strong>NICK.VN</strong></span></span>&nbsp;
                                &nbsp;<a
                            ...
                            <p><span style="font-size:14px"><span style="color:#ffffff">Chuy&ecirc;n mua
                                        b&aacute;n nick&nbsp;all game, </span><a href="https://napgamegiare.net/"><span
                                            style="color:#ffffff">nạp game
                                            gi&aacute; rẻ</span></a><span style="color:#ffffff">,&nbsp;an
                                        to&agrave;n,&nbsp;tin cậy, nhanh ch&oacute;ng. Giao dịch tự động
                                        24/24</span></span>
                            </p>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <strong>
                                        <span style="font-size:14px">
                                            <a href="/huong-dan-mua-tai-khoan" target="_blank">
                                                <span style="color:#ffffff">Hướng Dẫn Mua T&agrave;i Khoản</span>
                                            </a>
                                        </span>
                                    </strong>
                                </li>
                                <li>
                                    <strong>
                                        <span style="font-size:14px">
                                            <a href="/huong-dan-nick-mua-tra-gop" target="_blank">
                                                <span style="color:#ffffff">Hướng Dẫn Mua Nick Trả
                                                    G&oacute;p</span>
                                            </a>
                                        </span>
                                    </strong>
                                ...
                                <li>
                                    <strong>
                                        <span style="font-size:14px">
                                            <a href="/tuyen-dai-ly-cung-cap-nick-tai-nickvn" target="_blank"><span
                                ...
                                <li>
                                    <strong>
                                        <span style="font-size:14px">
                                            <a href="/lien-he-gop-y" target="_blank"><span
                                                    style="color:#ffffff">Li&ecirc;n hệ</span>
                                            </a>
                                        </span>
                                    </strong>
                                </li>
                                <li>
                                    <strong>
                                        <a href="https://gamecuoi.com/" target="_blank"><span style="color:#ffffff">
                                                <span style="font-size:14px">Tin tức&nbsp;game</span>
                                            </span>
                                        </a>
                                    </strong>
                                </li>
                    ...
                    <div class="col-md-6">
                        <div class="c-container c-last">
                            <h2>
                                <span style="color:#ffffff">
                                    <span style="font-size:22px">
                                        <strong>CH&Uacute;NG T&Ocirc;I Ở Đ&Acirc;Y</strong>
                                    </span>
                                </span>
                            </h2>
                            <h3>
                                <span style="color:#ffffff">
                                    <span style="font-size:16px">Ch&uacute;ng t&ocirc;i l&agrave;m việc một
                                        c&aacute;ch chuy&ecirc;n nghiệp, uy t&iacute;n, nhanh ch&oacute;ng v&agrave;
                                        lu&ocirc;n đặt quyền lợi của bạn l&ecirc;n h&agrave;ng đầu.</span>
                                </span>
                            </h3>
                            <p>&nbsp;</p>
                            ...
                            <p>
                                <span style="color:#ffffff">&nbsp;
                                    <strong>Thời gian l&agrave;m việc&nbsp;8h-11h30 &amp; 13h30-22h</strong>
                                </span>
                            </p>
                        </div>
                    </div>
